...
class Menu_Opt(State):
	...
	def update(self, deltatime, actions):
		...
		if self.positiony==0 or self.positiony==6:
			...
			self.positionx = ((self.positionx + movex) % 2) # realiza o movimento horizontal dentre as opções
	...
	def draw(self, canvas):
		...
		self.game.text(canvas, self.option[2], 36, pygame.Color("black"), w*0.16, h*0.9)
		...
		self.game.text(canvas, "EN", 36, pygame.Color("black"), w*0.255, h*0.9)
		...
		self.game.text(canvas, "PT", 36, pygame.Color("black"), w*0.3, h*0.9)
		...
		self.game.text(canvas, self.option[3], 36, pygame.Color("black"), w*0.6, h*0.9)
		...
		self.game.text(canvas, self.option[4], 36, pygame.Color("black"), w*0.85, h*0.9)
